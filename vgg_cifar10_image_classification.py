...
config = load_yaml("./config/vgg_cifar10_config.yml")
...
# Set the model
model = VGG(input_img=config['model']['input_img'], output_channel=config['model']['output_channel'], num_blocks=config['model']['num_blocks']).to(device)
